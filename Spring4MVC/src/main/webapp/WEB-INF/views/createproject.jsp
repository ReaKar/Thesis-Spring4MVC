...
<body>
  <jsp:include page="/WEB-INF/include/menu_admin.jsp"></jsp:include>
 	<div class="generic-container">
		...
		<div class="well lead">Create Project</div>
	 	<form:form method="POST" modelAttribute="project" class="form-horizontal" accept-charset="utf-8">
			<form:input type="hidden" path="idProject" id="idProject"/>
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="courses">Available courses</label>
					<div class="col-md-7">
<%-- 						<form:select path="idCourse" items="${courses}" multiple="false" itemValue="idCourse" itemLabel="title" class="form-control input-sm" /> --%>
...
<%--         </form:select> --%>
			...
			<div class="row">
				<div class="form-actions floatRight">
					<c:choose>
						<c:when test="${edit}">
							<input type="submit" value="Update" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/admin/projects' />">Cancel</a>
						</c:when>
						<c:otherwise>
							<input type="submit" value="Create" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/admin/home' />">Cancel</a>
						</c:otherwise>
					</c:choose>
				</div>
			</div>
