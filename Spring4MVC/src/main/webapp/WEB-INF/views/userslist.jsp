...
<body>
	...
	<div class="generic-container">
		...
		<div class="panel panel-default">
		  	...
		  	<div class="panel-heading"><span class="lead">List of Unacceptable Users </span> </div>
			...
			<table class="table table-hover">
				...
				<c:forEach items="${users}" var="user">
					<tr>
						...
						<td>${user.username}</td>
						<sec:authorize access="hasRole('admin')">
							<td><a href="<c:url value='/admin/accept-user-${user.username}' />" class="btn btn-success custom-width">accept</a></td>
				        </sec:authorize>
					    <sec:authorize access="hasRole('admin')">
		...
		<sec:authorize access="hasRole('admin')">
		 	<div class="well">
		 		...
		 		<div class=text-right> 
							<a href="<c:url value='/admin/accept-all' />" class="btn btn-success custom-width">Accept All</a>
				       </div>
